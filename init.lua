...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
        ...
        extensions = {
          ...
          live_grep_args = {
            ...
            mappings = {         -- extend mappings
              i = {              -- https://github.com/nvim-telescope/telescope-live-grep-args.nvim
      ...
      vim.keymap.set('n', '<leader>re', builtin.registers, { desc = 'Search [R]egisters' })

      -- Add live_grep_args mapping
      vim.keymap.set('n', '<leader>si', function()
        require('telescope').extensions.live_grep_args.live_grep_args()
      end, { desc = '[S]earch with [G]rep Args' })
  ...
  },
  {
    ...
    config = function()
      ...
      conform.setup {
        ...
        format_on_save = {
          timeout_ms = 500,    -- Time limit for formatting
  ...
  -- inspired by https://www.youtube.com/watch?v=B8BoPkga-_E
  {
    {
  ...
  -- },
  {
    ...
    -- set up leader ng for neogit
    keys = { { "<leader>ng", ":Neogit<CR>", desc = "Neogit" } },
    config = true
  },
  -- {
